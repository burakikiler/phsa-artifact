#!/bin/bash
# This is a inspired from the original DDEV startup script.
# See https://github.com/ddev/ddev/blob/v1.21.6/containers/ddev-webserver/ddev-webserver-base-scripts/start.sh
